							...
							{activeTab === "knowMore" && (
								<div className="space-y-6">
									...
									<div 
										...
										dangerouslySetInnerHTML={{ __html: company.terms_conditions }}
									/>
									)}
								</div>
							)}
									...
									<div>
										...
										<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
											<div className="p-3 bg-gray-50 rounded">
												<span className="font-medium">Hotel Code:</span> {company.hotel_code}
											</div>
											<div className="p-3 bg-gray-50 rounded">
											...
											{/* <div className="p-3 bg-gray-50 rounded">
												<span className="font-medium">Market Manager:</span> {company.market_managers}
											</div> */}
										</div>
									</div>
								</div>
								...
								<div className="p-4 bg-black/50 border-t">
									<div className="relative flex items-center">
										<button
											...
											onClick={() => {
												const newIndex = (selectedRoom.currentImageIndex || 0) - 1;
												if (newIndex >= 0) {
													setSelectedRoom({
														...selectedRoom,
